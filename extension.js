const runLoader = () => {
  ...
  notice.setAttribute('style', 'font-size: 24px !important; -webkit-text-stroke: 0.2px #fff;');
  notice.textContent = 'Genius Editor를 로딩하고 있습니다.';
  // notice.style.color = '#00c73c';
  notice.style.color = 'white';
  notice.style.zIndex = 1002;
  notice.style.position = 'absolute';
  notice.style.top = 'calc(50% + 40px)';
  notice.style.left = 'calc(50% - 64px)';
