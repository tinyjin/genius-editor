...
let inputBufferFrame;

for(let i = 0, len = iframeList.length; i < len; i += 1) {
  const currentFrame = iframeList[i];
  if (currentFrame.id.match(new RegExp('input_buffer(.+)[0-9]'))) {
    inputBufferFrame = iframeList[i];
    break;
  }
}
...
// 컨텐츠 요소들을 포함하는 상위 뢔퍼
const contentLineWrapper = document.querySelector('.se-components-wrap');
...
const inputBuffer = inputBufferFrame.contentWindow.document.querySelector('#inputBuffer');
...
inputBuffer.onkeydown = (event) => {
  ...
  if((keyCode === 191 && !(event.shiftKey)) || (text.endsWith('/')) && !isCommanderOn) {
    ...
    allLines.forEach((line, i) => {
      ...
      const currentCaretTop = document.querySelectorAll('.se-caret')[1].getClientRects()[0].top + 6;
  ...
  if (keyCode !== 32 && !(text.match(/\s$/))) return;
...
const clearFormat = () => {
  setTimeout(() => {
    document.querySelector('.se-toolbar-button-font-size-code').click();
    document.querySelector('.se-toolbar-select-option-item.se-font-size-code.se-font-size-code-fs15.se-fs15').click();
  }, 100);
};
...
const setHeader1 = () => {
  ...
  setTimeout(() => {
    document.querySelector('#blog-editor > div > div > div > header > div.se-header-inbox.se-l-property-toolbar > ul > li.se-toolbar-button-item.se-toolbar-item-font-size-code > div > button').click();
    document.querySelector('.se-toolbar-select-option-item.se-font-size-code.se-font-size-code-fs34.se-fs34').click();
  }, 100);
};
...
const setHeader2 = () => {
  ...
  setTimeout(() => {
    document.querySelector('#blog-editor > div > div > div > header > div.se-header-inbox.se-l-property-toolbar > ul > li.se-toolbar-button-item.se-toolbar-item-font-size-code > div > button').click();
    document.querySelector('.se-toolbar-select-option-item.se-font-size-code.se-font-size-code-fs24.se-fs24').click();
  }, 100);
};
...
const setHeader3 = () => {
  ...
  setTimeout(() => {
    document.querySelector('#blog-editor > div > div > div > header > div.se-header-inbox.se-l-property-toolbar > ul > li.se-toolbar-button-item.se-toolbar-item-font-size-code > div > button').click();
    document.querySelector('.se-toolbar-select-option-item.se-font-size-code.se-font-size-code-fs19.se-fs19').click();
  }, 100);
};
...
const toggleSourceCode = () => {
  ...
  document.querySelector('button.se-toolbar-button-code').click();
};
...
const commanderToolList = [
  {
    ...
    className: '.se-toolbar-button-image'
  },
  {
    name: '동영상',
    desc: '동영상을 입력합니다.',
    ...
    className: '.se-toolbar-button-video'
  },
  {
    name: '인용구',
    desc: '인용구를 입력합니다.',
    ...
    className: '.se-toolbar-button-quotation'
  },
  {
    name: '장소',
    desc: '장소를 입력합니다.',
    ...
    className: '.se-toolbar-button-map'
  },
  {
    name: '링크',
    desc: '링크를 입력합니다.',
    ...
    className: '.se-toolbar-button-oglink'
  },
  {
    name: '파일',
    desc: '일정을 입력합니다.',
    ...
    className: '.se-toolbar-button-file'
  },
  {
    name: '표',
    desc: '표를 입력합니다.',
    ...
    className: '.se-toolbar-button-table'
  },
  {
    name: '수식',
    desc: '수식을 입력합니다.',
    ...
    className: '.se-toolbar-button-formula'
  },
];

const toggleCommander = () => {
  const smartEditorContainer = document.querySelector('#drag-ghost');
  ...
  // 포커스 가로채기
  const hiddenInput = document.querySelector('.gep-hidden-input');
  hiddenInput.blur();
  hiddenInput.focus();

  // 커맨더 스타일링
  const commanderStyle = document.querySelector('.gep-commander').style;
  ...
  // 제목 스타일링
  const commanderTitle = document.querySelector('.gep-commander-title');
  ...
  // 툴 목록 추가
  const commanderList = document.querySelector('.gep-commander-list');
  let listHTML = '';
  ...
  const toolList = document.querySelectorAll('.gep-commander-tool');
  for (let i = 0, len = toolList.length; i < len; i += 1) {
    ...
    tool.onclick = () => {
      hideCommander();
      document.querySelector(commanderToolList[i].className).click();
...
const hideCommander = () => {
  ...
  const commander = document.querySelector('.gep-commander');
...
const showCommander = () => {
  ...
  const firstTool = document.querySelector('.gep-commander-tool');
...
const scorllIfNotInScroll = (element) => {
  const scroll = document.querySelector('.gep-commander');
